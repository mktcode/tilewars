...
const baseColor = computed(() => player1Unit.value ? 'bg-orange-900' : 'bg-violet-900');
const tankColor = computed(() => player1Unit.value ? 'bg-orange-500' : 'bg-violet-500');
const soldierColor = computed(() => player1Unit.value ? 'bg-orange-400' : 'bg-violet-400');
const sniperColor = computed(() => player1Unit.value ? 'bg-orange-300' : 'bg-violet-300');
</script>
